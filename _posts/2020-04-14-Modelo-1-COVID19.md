...
O notebook com todos os códigos utilizados nesta etapa estão disponíveis [aqui](https://github.com/deepdados/ProjetoCOVID/blob/master/preProcessamento_COVID_modelo1.ipynb)<br />
