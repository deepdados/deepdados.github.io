...
**21º Pasoo** - [Indicar os casos que são COVID-19, os que são normais e os casos com outras infecções e criar um array](indicar-os-casos-que-são-covid-19-os-que-são-normais-e-os-casos-com-outras-infecções-e-criar-um-array)<br />
